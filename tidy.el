...
where they exist in the input.")
    ...
    ("break-before-br" "Fix Markup" "Boolean" "yes"
     "
Type: Boolean
Default: no
Example: y/n, yes/no, t/f, true/false, 1/0
...
element.")
    ...
    ("char-encoding" "Encoding" "Encoding" "utf8"
     "
Type: Encoding
Default: ascii
...
generic XML documents unchanged.")
    ...
    ("drop-empty-paras" "Fix Markup" "Boolean" "no"
     "
Type: Boolean
Default: yes
Example: y/n, yes/no, t/f, true/false, 1/0
...
outputting to XML.")
    ...
    ("indent" "Indentation" "AutoBool" "auto"
     "
Type: AutoBool
Default: auto
...
when indentation is enabled.")
    ...
    ("input-encoding" "Encoding" "Encoding" "ascii"
     "
Type: Encoding
Default: ascii
Example: ascii, latin1, raw, utf8, iso2022, mac, win1252
...
element.")
    ...
    ("join-styles" "Fix Markup" "Boolean" "no"
     "
Type: Boolean
Default: yes
Example: y/n, yes/no, t/f, true/false, 1/0
...
XHTML documents.")
    ...
    ("markup" "Input/Output" "Boolean" "no"
     "
Type: Boolean
Default: yes
Example: y/n, yes/no, t/f, true/false, 1/0
...
always written for XML/XHTML output using UTF-16 output encodings.")
    ...
    ("output-encoding" "Encoding" "Encoding" "utf8"
     "
Type: Encoding
Default: ascii
Example: ascii, latin1, raw, utf8, iso2022, mac, win1252
...
Latin encodings (ascii, latin1, mac, win1252).")
    ...
    ("output-xhtml" "Input/Output" "Boolean" "yes"
     "
Type: Boolean
Default: no
Example: y/n, yes/no, t/f, true/false, 1/0
...
regardless of other options.")
    ...
    ("output-xml" "Input/Output" "Boolean" "yes"
     "
Type: Boolean
Default: no
Example: y/n, yes/no, t/f, true/false, 1/0
...
(let ((options-alist tidy-options-alist)
  ...
  (while (setq option (car options-alist))
    ...
    (set-default symbol (nth 3 option)) ;;default)
          ...
          (save-excursion
            ...
            (while (setq option (car option-alist))
              ...
              (save-excursion ;; this is a local variable
                ...
                (setq value (or (symbol-value symbol) (default-value symbol))))
...
generated by that program are sent to \"*tidy-errors*\" buffer."
  ...
  (let* ((start (if (null prefix) (point-min) (mark)))
         ...
         (config-file (or tidy-config-file
                          (concat
                           ;; name may or may not end in "/"
                           (directory-file-name tidy-temp-directory)
                           "/temp-tidy-config")))
    ...
    (when (get-buffer-create temp-buffer) ;; flush the temp buffer
      (save-excursion
    ...
    (if (and (file-exists-p config-file)
             (not (equal config-file tidy-config-file)))
